...
public class AddToCartPage {
    ...
    private final By DeleteBtn      = By.xpath("//button[contains(@class, 'btn-danger') and @data-original-title='Remove']");
    private final By EmptyCartMsg   = By.xpath("//*[@id=\"content\"]/p");
...
*/
    ...
    public void ShoppingCartNotView(){
        driver.findElement(ShoppingCart).click();
        Assert.assertEquals(driver.findElement(EmptyCartMsg).getText(),"Your shopping cart is empty!");
    }

    public void ShoppingCartViewV2() {
        driver.findElement(ShoppingCart).click();

        boolean isItem1Displayed = driver.findElement(ItemModel1).isDisplayed();
        boolean isItem2Displayed = driver.findElement(ItemModel2).isDisplayed();

        Assert.assertTrue(isItem1Displayed, "Item Model 1 is not displayed in shopping cart.");
        Assert.assertTrue(isItem2Displayed, "Item Model 2 is not displayed in shopping cart.");
    }
